    ...
    <>
      <Box border={"1px solid gray"} borderRadius={4} padding={5}>
        <VStack spacing={4}>
          ...
          <Input 
            placeholder='Email' fontSize={14} type={"email"} value={inputs.email}
            onChange={(e) => setInputs({...inputs,email:e.target.value})} 
          />
          <Input 
            placeholder='Password' fontSize={14} type={"password"} value={inputs.password}
            onChange={(e) => setInputs({...inputs,password:e.target.value})}
          />

          {!isLogin ? (
            <Input 
            placeholder='Confirm Password' fontSize={14} type={"password"} value={inputs.confirmPassword}
